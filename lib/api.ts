...
export interface Income {
  id: string; title: string; amount: number;
  category: string; date: string; note?: string; created_at?: string;
}
...
async function q<T>(builder: { data: T | null; error: { message: string } | null } | PromiseLike<{ data: T | null; error: { message: string } | null }>): Promise<T> {
